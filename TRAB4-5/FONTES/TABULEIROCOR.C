...
#define TABULEIROCOR_OWN
#include "TABULEIROCOR.H"
#undef TABULEIROCOR_OWN
    ...
    for ( lin = 0 ; lin < 31 ; lin++ ) 
    {
        for ( col = 0 ; col < 61 ; col++ ) 
        {
            if ( matriz[lin][col] >= '0' && matriz[lin][col] <= '3' && matriz[lin][col+1] >= '0' && matriz[lin][col+1] <= '3' ) 
            {
                ...
                pcor(cor); printf("p%c",matriz[lin][col+1]);pcor(4);
                col++;
            }

            // PINTANDO LINHAS VERMELHAS
            else if ( (lin == 12 && (col > 3 && col < 9)) == 1 )
            {
                pcor(0); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 13 && (col == 4 || col == 8) ) == 1 )
            {
                pcor(0); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 14 && (col > 3 && col < 29) ) == 1 )
            {
                pcor(0); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 15 && (col == 4 || col == 8 || col == 12 || col == 16 || col == 20 || col == 24 || col == 28)) == 1 )
            {
                pcor(0); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 16 && (col > 3 && col < 29) ) == 1 )
            {
                pcor(0); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }

            //PINTANDO LINHAS AZUIS
            else if ( ( ( lin == 2 || lin == 4 ) && (col > 27 && col < 37) ) == 1 )
            {
                pcor(1); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 3 && (col == 28 || col == 32 || col == 36) ) == 1 )
            {
                pcor(1); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 5 || lin == 7 || lin == 9 || lin == 11 || lin == 13 ) && (col == 28 || col == 32 ) == 1 )
            {
                pcor(1); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( ( lin == 6 || lin == 8 || lin == 10 || lin == 12 || lin == 14 ) && (col > 27 && col < 33) ) == 1 )
            {
                pcor(1); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }

            //PINTANDO LINHAS AMARELAS
            else if ( ( ( lin == 14 || lin == 16 ) && (col > 31 && col < 57) ) == 1 )
            {
                pcor(3); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 15 && (col == 32 || col == 36 || col == 40 || col == 44 || col == 48 || col == 52 || col == 56 )) == 1 )
            {
                pcor(3); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 17 && (col == 52 || col == 56)))
            {
                pcor(3); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( ( lin == 18 && (col > 51 && col < 57) ) == 1)
            {
                pcor(3); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }

            //PINTANDO LINHAS VERDES
            else if ( (lin == 26 || lin == 28) && (col > 23 && col < 33))
            {
                pcor(2); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( (lin == 27) && (col == 24 || col == 28 || col == 32))
            {
                pcor(2); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( (lin == 16 || lin == 18 || lin == 20 || lin == 22 || lin == 24 || lin == 26 || lin == 28) && (col > 27  && col < 33 ))
            {
                pcor(2); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }
            else if ( (lin == 17 || lin == 19 || lin == 21 || lin == 23 || lin == 25 || lin == 27) && (col == 28 || col == 32))
            {
                pcor(2); printf ( "%c" , matriz[lin][col] ) ; pcor(4);
            }

            //PINTANDO LINHAS NORMAIS
            else
